...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#faf7f2]/95 backdrop-blur-sm px-4 sm:px-8 py-4 flex items-center justify-between font-sans border-b border-[#e5ddd0] sticky top-0 z-50">
      ...
      {/* Desktop Navigation Links (Hidden on mobile/tablet screens) */}
      ...
      {/* Desktop Call to Action Button (Hidden on mobile/tablet) */}
      ...
      {/* Hamburger Menu Toggle (Visible only on mobile/tablet viewports) */}
      <button
